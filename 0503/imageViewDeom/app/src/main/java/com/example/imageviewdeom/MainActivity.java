package com.example.imageviewdeom;
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.rdbDog) {
                    image1.setImageResource(ImageView.VISIBLE);
                    image2.setImageResource(ImageView.GONE);
                    image3.setImageResource(ImageView.GONE);
                    image4.setImageResource(ImageView.GONE);
                } else if (checkedId == R.id.rdbElephant) {
                    image1.setImageResource(ImageView.GONE);
                    image2.setImageResource(ImageView.VISIBLE);
                    image3.setImageResource(ImageView.GONE);
                    image4.setImageResource(ImageView.GONE);
                } else if (checkedId == R.id.rdbMouse) {
                    image1.setImageResource(ImageView.GONE);
                    image2.setImageResource(ImageView.GONE);
                    image3.setImageResource(ImageView.VISIBLE);
                    image4.setImageResource(ImageView.GONE);
                } else if (checkedId == R.id.rdbRabbit) {
                    image1.setImageResource(ImageView.GONE);
                    image2.setImageResource(ImageView.GONE);
                    image3.setImageResource(ImageView.GONE);
                    image4.setImageResource(ImageView.VISIBLE);
                }
