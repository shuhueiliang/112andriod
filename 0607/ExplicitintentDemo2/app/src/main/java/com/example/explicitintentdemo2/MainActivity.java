...
public class MainActivity extends AppCompatActivity {
    ...
    class ResultContract extends ActivityResultContract<Boolean, String> {
        ...
        public Intent createIntent(@NonNull Context context, Boolean aBoolean) {
            Intent intent = new Intent(MainActivity.this, OpAciivity.class);
            Bundle bundle = new Bundle();
            bundle.putString("OPERANDO01",((EditText) findViewById(R.id.txtOpd1)).getText().toString());
            bundle.putString("OPERANDO02",((EditText) findViewById(R.id.txtOpd2)).getText().toString());
